...
//------------------------------------------------------------------------------
int Util_LBP_CV::LBP_RGB_Eyes(cv::Mat &imgRGB, cv::Mat_<double> &features)
{
	cv::Rect eye1;
	cv::Rect eye2;
...
//------------------------------------------------------------------------------
int Util_LBP_CV::LBP_RGB_Hair(cv::Mat &imgRGB, cv::Mat_<double> &features)
{
	cv::Rect eye1;
	cv::Rect eye2;
	bool detect = Util_Eyes::detectEyes(imgRGB, eye1, eye2);
