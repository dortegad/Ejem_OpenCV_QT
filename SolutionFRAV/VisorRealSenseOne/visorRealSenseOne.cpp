...
//--------------------------------------------------------------------------------------------------------------
const std::string VisorRealSenseOne::WINNAME_RGB = "real image RGB";
const std::string VisorRealSenseOne::WINNAME_Depth = "real image Depth";
const std::string VisorRealSenseOne::WINNAME_IR = "real image IR";
const std::string VisorRealSenseOne::WINNAME_FLIR = "real image FLIR";
...
//--------------------------------------------------------------------------------------------------------------
void VisorRealSenseOne::showImg_1(const cv::Mat &imagen)
{
...
//--------------------------------------------------------------------------------------------------------------
void VisorRealSenseOne::createMapDepth(PXCProjection *projection,
									PXCImage *depth, 
...
//--------------------------------------------------------------------------------------------------------------
bool VisorRealSenseOne::showSampleAdjustColor(PXCCapture::Device *device,
...
//--------------------------------------------------------------------------------------------------------------
PXCSenseManager * VisorRealSenseOne::setup()
{
...
//--------------------------------------------------------------------------------------------------------------
int VisorRealSenseOne::stream(PXCSenseManager *pp)
{
	stopStream = false;
...
//--------------------------------------------------------------------------------------------------------------
void VisorRealSenseOne::selectFile()
{
